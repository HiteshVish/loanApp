...
@if(Auth::user()->isAdmin())
    ...
    <!-- Statistics Cards Row 4 - KYC Applications -->
    <div class="row dashboard-row mb-4">
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
            <div class="card statistics-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <span class="d-block mb-1 text-muted">Total Applications</span>
                            <h3 class="card-title mb-1">{{ number_format($totalApplications ?? 0) }}</h3>
                            @if(isset($applicationGrowth) && $applicationGrowth != 0)
                                <small class="{{ $applicationGrowth > 0 ? 'text-success' : 'text-danger' }}">
                                    <i class='bx {{ $applicationGrowth > 0 ? 'bx-up-arrow-alt' : 'bx-down-arrow-alt' }}'></i>
                                    {{ abs($applicationGrowth) }}% this month
                                </small>
                            @endif
                        </div>
                        <div class="d-flex align-items-center justify-content-center" style="width: 56px; height: 56px;">
                            <div class="avatar avatar-lg bg-label-primary" style="width: 56px; height: 56px; display: flex; align-items: center; justify-content: center;">
                                <i class='bx bx-file' style="font-size: 1.5rem; display: flex; align-items: center; justify-content: center; line-height: 1;"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-1 text-warning">{{ number_format($pendingApplications ?? 0) }}</h3>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-1 text-success">{{ number_format($approvedApplications ?? 0) }}</h3>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-1 text-danger">{{ number_format($rejectedApplications ?? 0) }}</h3>
                            <small class="text-muted">Not approved</small>
                        </div>
                        <div class="d-flex align-items-center justify-content-center" style="width: 56px; height: 56px;">
                            <div class="avatar avatar-lg bg-label-danger" style="width: 56px; height: 56px; display: flex; align-items: center; justify-content: center;">
                                <i class='bx bx-x-circle' style="font-size: 1.5rem; display: flex; align-items: center; justify-content: center; line-height: 1;"></i>
                            </div>
                        </div>
                    </div>
                </div>
